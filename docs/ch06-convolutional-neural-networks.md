...
[卷积基础完整代码](../code/ch06/convolution_basics.py) · [2→16 通道扩展示例](../code/ch06/channel_expansion_demo.py) · [LeNet 完整训练代码](../code/ch06/lenet_smoke.py) · [官方章节目录](https://zh.d2l.ai/chapter_convolutional-neural-networks/index.html)
