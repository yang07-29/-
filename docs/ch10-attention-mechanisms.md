...
> 原创学习笔记，正式小节对照[《动手学深度学习》中文 2.0 官方目录](https://zh.d2l.ai/chapter_attention-mechanisms/index.html)
...
若查询、键各分量近似独立且方差为 1，$d$ 项乘积之和的方差约为 $d$，标准差约为 $\sqrt d$。除以标准差可把分数尺度稳定在相近范围，避免维度增大时 softmax 过尖和梯度变小。
