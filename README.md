...
2. 看机制图，先弄清数据、状态或梯度怎样流动。
3. 遇到公式时，先看符号和 Shape，再看推导。
4. 正文重点解释代码在训练流程中的职责；完整程序统一放在 `code/`。
5. 运行代码后，先遮住答案完成章末主动回忆，不要只看损失是否下降。
...
这些笔记用于解释与复习，不替代教材。章节脉络参考[《动手学深度学习》中文官方文档](https://zh.d2l.ai/)，所有正文均为面向学习的原创转述；代码是可运行的教学实现，并以中文注释解释关键步骤。
